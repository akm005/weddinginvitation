          ...
          <div class="col-md-12 col-lg-6 d-flex justify-content-center align-items-center">
            <div class="contact-info mx-lg-5 h-100 w-100">
              <div class="info-list d-flex justify-content-center  justify-content-md-around">
                <div class="info-ico d-none d-md-block">
                  <img src="assets/images/icons/2.png" alt="" />
                </div>

                <div onClick={handleClick} tabIndex={0} class="info-content w-100 d-flex flex-row gap-3 flex-lg-column justify-content-between justify-content-sm-center align-items-center p-0">
                  <span className="flex-sm-grow-1 text-start text-lg-center">
                    <h2>Location</h2>

                    <p className="font-italic">
                      Milan Marriage Hall, Nedula Churaha Banjariya Road
                      Khalilabad,
                      <br />
                      Uttar Pradesh, India
                    </p>
                  ...
                  <button
                    type="button"
                    className="clickable d-inline-flex align-items-center me-3 me-lg-0"
                    onClick={handleClick}
                  >
                    <span class="material-symbols-outlined">assistant_direction</span>
                    <span className="d-sm-block d-none">Navigate</span>
                  </button>
                </div>
              </div>
              ...
              <div class="info-list d-flex justify-content-center  justify-content-md-around">
                ...
                <div onClick={handleCall} tabIndex={0} class="info-content w-100 d-flex flex-row gap-3 flex-lg-column justify-content-between  justify-content-sm-center align-items-center p-0">
                  <span className="flex-sm-grow-1 text-start text-lg-center">
                    <h2>Phone</h2>
                  ...
                  >
                    ...
                    <span className="d-sm-block d-none">Call</span>{" "}
                  </button>
                </div>
              </div>
            </div>
